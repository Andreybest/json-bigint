...
var json_parse = function (options) {
  ...
  var _options = {
    ...
    useOldNumberParser: false, // toggles whether to use the old number parser (v0.4.0) instead of new one
    protoAction: 'error',
  ...
  if (options !== undefined && options !== null) {
    ...
    _options.useOldNumberParser =
      options.useOldNumberParser === true ? options.useOldNumberParser : false;
  ...
  var at, // The index of the current character
    ...
    number = function () {
      ...
      if (!isFinite(number)) {
        error('Bad number');
      } else if (_options.useOldNumberParser) {
