...
describe("Testing if old parser works like in old version (Testing old Testing native BigInt support: parse)", function () {
  ...
  it("Should show JSONbig does work like in version v0.4.0", function (done) {
    var JSONbig = require('../index')({
      storeAsString: true,
      useOldNumberParser: true,
    });
    var obj = JSONbig.parse(input);
    expect(obj.big, "big int").to.be.a('string');
    expect(obj.small, "small int").to.be.a('number');
    done();
  });
});